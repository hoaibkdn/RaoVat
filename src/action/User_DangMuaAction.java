...
public class User_DangMuaAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		//neu khong lam gi thi van o trang dang bai mua
		...
		return mapping.findForward("themBaiDangMua");
	}
}
