...
public class DanhSachBaiDangBanAction extends Action{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		baiDangLst = bdBo.getBaiDangList("LBD1",1);
		System.out.println("list bai dang ban: ");
		...
		if(tenDangNhap != null) 
		{
			...
			String phanHoi = phBo.getContentPH(tenDangNhap);
			dangBanForm.setNoiDungPhanHoi(phanHoi);
		}
		...
		if("TÃ¬m kiáº¿m".equals(dangBanForm.getSubmit()))
		{
			...
			if((tatCa != null||"".equals(tatCa)) && ((tenSanPham == null && namSanXuat == null)|| ("".equalsIgnoreCase(tenSanPham)) && "".equals(namSanXuat))
					&&((idDanhMuc == null && giaThap == null && giaCao == null )
					|| (idDanhMuc.equals("0") && giaThap.equals("0") && giaCao.equals("0"))))
			{
				baiDangTimKiem = bdBo.getBaiDangTuKhoa(tatCa, "LBD1");
