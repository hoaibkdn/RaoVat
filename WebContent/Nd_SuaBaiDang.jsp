...
<jsp:include page="benTrai.jsp"></jsp:include>
	<div class="col-md-8 col-md-offset-3 control-border margin-box">
		...
		<html:form action="/suaBaiDang" enctype="multipart/form-data">
			<div class="col-sm-12">
				<div class="col-sm-12 title-main">ĐĂNG BÁN</div>
				<div class="col-sm-12">
					<hr></hr>
				</div>
				...
				<div class="form-group col-sm-12 col-md-offset-1" >
				...
				<div class="form-group col-sm-12 log-insert">
					<div class="col-sm-10">
						<div class="col-sm-6">
							<html:submit property="submit" value="Sửa"
